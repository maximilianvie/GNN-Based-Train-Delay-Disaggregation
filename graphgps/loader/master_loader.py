...
from graphgps.loader.dataset.custom_oebb import custom_oebb
...
def log_loaded_dataset(dataset, format, name):
    ...
    if hasattr(dataset, 'num_edge_features'):
        ...
        logging.info("  num edge features: Not available")
...
def load_dataset_master(format, name, dataset_dir):
    ...
    # GraphGym default loader for Pytorch Geometric datasets
        ...
        dataset = custom_oebb(root=dataset_dir, pickle_file= cfg.train.pkl_filepath, mode = cfg.train.mode )
